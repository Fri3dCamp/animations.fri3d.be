...
var Boid = function() {
	...
	_maxSpeed = 4, _maxSteerForce = 0.05, _avoidWalls = false;
...
function init() {
	...
	renderer.setClearColor( 0x0e96af );
...
function render() {
    ...
    color.r = scale( 1, 0.0546875, z ); 
    color.g = scale( 1, 0.5859375, z );
    color.b = scale( 1, 0.68359375, z );
